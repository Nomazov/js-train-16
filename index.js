...
function validateUserInput(userInput) {
    ...
    console.assert("username" in userInput, "Помилка: ім'я користувача відсутнє!");

    console.assert("password" in userInput, "Помилка: пароль відсутній!");
...
function countVowelsAndConsonants(word) {
    ...
    console.log(`Голосні: ${count1}`);

    console.log(`Приголосні: ${count2}`);
